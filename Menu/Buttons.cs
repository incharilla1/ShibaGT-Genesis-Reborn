    ...
    internal class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            { // Main Mods [ ALWAYS KEEP THIS FIRST NO MATTER WHAT ]
                ...
                new ButtonInfo { buttonText = "Spotify", method = () => SettingsMods.spotify(), isTogglable = false, toolTip = "Spotify player"},
            },
            ...
            { // fun [5]
                ...
                new ButtonInfo { buttonText = "Voice Harmonizer", enableMethod =() => mods.harmonizerMic = true, disableMethod =() => mods.harmonizerMic = false, isTogglable = true, toolTip = "Harmonic choir voice modulation"},
                new ButtonInfo { buttonText = "Clean Microphone", enableMethod =() => mods.cleanMic = true, disableMethod =() => mods.cleanMic = false, isTogglable = true, toolTip = "Studio clean microphone with noise gate & compressor"},
            ...
            new ButtonInfo[]
            { // Projectile [7]
                new ButtonInfo { buttonText = "projtype", overlapText = "Projectile: snowball", method =() => mods.CycleProjectileType(), isTogglable = false, toolTip = "Cycle projectile type (Water Balloon, Snowball, Lava Rock, etc.)"},
                ...
                new ButtonInfo { buttonText = "Projectile Spam (B)", method =() => mods.ProjectileSpam(GorillaLocomotion.GTPlayer.Instance.RightHand.velocityTracker.GetAverageVelocity(true, 0f), GorillaLocomotion.GTPlayer.Instance.RightHand.controllerTransform.position), isTogglable = true, toolTip = "Hold B to spam from hand"},
                new ButtonInfo { buttonText = "Dual Projectile Spam", method =() => mods.DualProjectileSpam(), isTogglable = true, toolTip = "Rapid-fire alternating stream from both hands"},
                new ButtonInfo { buttonText = "Projectile Shotgun", method =() => mods.ProjectileShotgun(), isTogglable = true, toolTip = "Fire 6-shot cone spread of projectiles"},
                new ButtonInfo { buttonText = "Projectile Launcher", method =() => mods.ProjectileLauncher(), isTogglable = true, toolTip = "Press left or right grip to launch a projectile"},
            ...
            { // Menu Settings
                ...
                new ButtonInfo { buttonText = "PPos", overlapText = "Page Buttons: " + Settings.pageButtonNames[Settings.pageButtonIndex], isTogglable = false, method =() => mods.SwitchPagePos(), enabled = false, toolTip = "Cycle page navigation mode (ShibaGT, Sides, Grip, Trigger)"},
                new ButtonInfo { buttonText = "Keybinds", method =() => SettingsMods.keybinds(), toolTip = "Keybind manager", isTogglable = false},
                ...
                new ButtonInfo { buttonText = "Rounded Menu", isTogglable = true, enableMethod = () => { Settings.roundedMenu = true; Main.RecreateMenu(); }, disableMethod = () => { Settings.roundedMenu = false; Main.RecreateMenu(); }, enabled = Settings.roundedMenu, toolTip = "Toggle rounded buttons and menu background" },
                ...
                new ButtonInfo { buttonText = "menu opening animations", overlapText = "Open Anim: " + Settings.openAnimNames[Settings.openAnimIndex], isTogglable = false, method = () => Main.Change("menu opening animations", ref Settings.openAnimIndex, Settings.openAnimNames), toolTip = "Cycle menu opening animation style" },
                new ButtonInfo { buttonText = "button style", overlapText = "Button Style: " + Settings.buttonStyleNames[Settings.buttonStyleIndex], isTogglable = false, method = () => Main.Change("button style", ref Settings.buttonStyleIndex, Settings.buttonStyleNames, () => Main.RecreateMenu()), toolTip = "Cycle button appearance style" },
            ...
            { // Move Set
                ...
                new ButtonInfo { buttonText = "Sticky Platforms", enableMethod =() => mods.stickyPlatforms = true, disableMethod =() => mods.stickyPlatforms = false, isTogglable = true, toolTip = "Hands stick to platforms to prevent slipping"},
            },
            ...
            new ButtonInfo[]
            { // Spotify [25]
                new ButtonInfo { buttonText = "Play / Pause", method = () => SpotifyManager.TogglePlay(), isTogglable = false },
                new ButtonInfo { buttonText = "Next Track", method = () => SpotifyManager.NextTrack(), isTogglable = false },
                new ButtonInfo { buttonText = "Previous Track", method = () => SpotifyManager.PreviousTrack(), isTogglable = false },
                new ButtonInfo { buttonText = "Restart Song", method = () => SpotifyManager.RestartTrack(), isTogglable = false },
                new ButtonInfo { buttonText = "Stop", method = () => SpotifyManager.StopPlayback(), isTogglable = false },
                new ButtonInfo { buttonText = "Spotify Mute", method = () => SpotifyManager.Mute(), isTogglable = false },
                new ButtonInfo { buttonText = "Track Info", method = () => SpotifyManager.ShowTrackNotification(), isTogglable = false },
                new ButtonInfo { buttonText = "Copy Song Name", method = () => SpotifyManager.CopyCurrentTrack(), isTogglable = false },
                new ButtonInfo { buttonText = "Spotify HUD", enableMethod = () => SpotifyManager.EnableHUD(), disableMethod = () => SpotifyManager.DisableHUD(), isTogglable = true, enabled = SpotifyManager.ShowHUD },
                new ButtonInfo { buttonText = "Auto Track Notify", enableMethod = () => SpotifyManager.AutoNotifyTrack = true, disableMethod = () => SpotifyManager.AutoNotifyTrack = false, isTogglable = true, enabled = SpotifyManager.AutoNotifyTrack },
                new ButtonInfo { buttonText = "Launch Spotify", method = () => SpotifyManager.LaunchSpotify(), isTogglable = false },
                new ButtonInfo { buttonText = "Focus Spotify", method = () => SpotifyManager.FocusSpotify(), isTogglable = false },
                new ButtonInfo { buttonText = "Minimize Spotify", method = () => SpotifyManager.MinimizeSpotify(), isTogglable = false },
                new ButtonInfo { buttonText = "Close Spotify", method = () => SpotifyManager.CloseSpotify(), isTogglable = false },
            },
            new ButtonInfo[]
            { // dont remove this
                new ButtonInfo { buttonText = "home", method = () => SettingsMods.ReturnHome(), isTogglable = false, toolTip = "Return home" },
            }
        };
    }
}
